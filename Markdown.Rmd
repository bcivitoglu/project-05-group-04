...
To **decide which pca we will use for further analysis**, we draw a heatmap showing which principle component is affected significantly by a batch effect. All significant p-values are shown in red and non-significant ones in blue.
...
One can see that our sick and healthy patients belong to two different clusters so we can use pricipal component two for further testing.
