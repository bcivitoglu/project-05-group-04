...
Using different categories of the annotation tbale makes it possible to check for a possible **batch effect**. Batch effect is a **technical source of error**. It is important that the technical variation does not confound with the biology to not falsify the interpreted data. Therfore it is important to check for a batch effect to see whether the variance explained by the principal components is related to technical error or by biological influence.

We check for a batch effect to see whether the variance our PC explains Is related to technical error or biological influence 
...
By looking at the heatmap or at the p-values one can see that principal component 1 has batch effect for the categories "sample desc" and "biomaterial provider".
...
Looking at the heatmap shows that principal component one shows batch effect for three categories, or two categories of investigation and a category of controll respectively.
