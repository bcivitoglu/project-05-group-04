...
For numbers we use the permutation test (of Pearson's r correlation coefficient), for 2 categories the Wilcoxon test and for more than 2 different categories the Kruskal-Wallis test.
